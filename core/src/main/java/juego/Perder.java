...
public class Perder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        niveles.setBounds(170, 220, 60, 40);
        ...
        next.setBounds(250, 220, 60, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/juego/13.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Perder().setVisible(true));
    }
