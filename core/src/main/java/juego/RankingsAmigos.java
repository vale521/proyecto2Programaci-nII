 ...
 * @author admin
 */
public class RankingsAmigos extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RankingsAmigos.class.getName());

    /**
     * Creates new form RankingsAmigos
     */
    public RankingsAmigos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/juego/amigos.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new RankingsAmigos().setVisible(true));
    }
